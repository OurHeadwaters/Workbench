 ...
 * call-out. Reframes the trial against Step 1 (the ~$41,000-a-month
 * Headwaters engagement — Practitioner invoicing at $150/hr as an
 * independent consultant, Tyler's company at $70/hr subcontract, IT/Support
...
export const TRIAL_ACCEPTANCE_CRITERIA_OJICREE: readonly TrialAcceptanceCriterionTranslation[] = [
  ...
  {
    index: 3,
    text: "Nitam-bibooni-zhooniyaa miinawaa zhooniyaa-ozhitoowin gii-miinaa onaakonigewikamigong mazina'igan-onji — Step 1 zhooniyaa-onji, ~$41,000-aabita-giizis-mazina'igan Headwaters (Practitioner $150/hr independent consultant + Tyler's company $70/hr subcontract + IT/Support partial + $5,000/mo overhead), miinawaa gaandeg-bimiwidoowin gaa-dibaakonigaadeg.",
  },
] as const;
...
export const TRIAL_TIMELINE_OJICREE: readonly TrialTimelineWeekTranslation[] = [
  ...
  },
  {
    ...
    deliverables:
      "Nitam-bibooni-zhooniyaa miinawaa zhooniyaa-ozhitoowin gii-miinaa onaakonigewikamigong mazina'igan-onji — Step 1 zhooniyaa-onji, ~$41,000-aabita-giizis-mazina'igan Headwaters (Practitioner $150/hr independent consultant + Tyler's company $70/hr subcontract + IT/Support partial + $5,000/mo overhead), miinawaa gaandeg-bimiwidoowin gaa-dibaakonigaadeg.",
    meetings:
