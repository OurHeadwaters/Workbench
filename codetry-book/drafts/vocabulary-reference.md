...
**Activated state** (Ch4) — One of the two operational states of The Standby. The infrastructure is the same as the resting state; only the valve position changes. In activated state: open call, deployed stock, live rosters in motion. The name holds across both states.

**Both-sides** (Ch4, principle) — A test for naming a primitive that faces two contexts simultaneously. Does the umbrella name hold from the bright side *and* from the massity side? If the name privileges one context, the membrane becomes a wall. Same word, different room.

**Both-states** (Ch4, principle) — A test for naming a primitive that moves between tempos. Does the umbrella name hold in the resting state *and* in the activated state? If the name bends to fit only one tempo, the system will eventually fork into two systems with two cultures. Same word, different rung.

**Bright side** (Ch4, foreshadowed in Ch4 body text) — The community's own dialect — the words a community uses with itself in its own kitchens, meetings, and ledgers. Neighbour. Channel. The books. Standby stock. The watch. Neither informal nor incorrect. Simply a different room. *The name originates in dementia care practice: an effective support person cannot hold massity's frame of reality and do the work simultaneously. Not because that side is better, but because certain things are only visible from inside it.*
...
**Refused** (Ch4) — A Gate outcome for source-side language that has no honest equivalent in the target dialect. The word does not cross. The document notes the gap. Protecting the word is more important than completing the translation. *Refused is a first-class outcome — not a failure, not a footnote.*

**Resting state** (Ch4) — One of the two operational states of The Standby. In resting state: always-on preparation — stocked shelves, current contact trees, regular test-starts, the watch reading morning advisories. The infrastructure is the same as the activated state; only the valve position changes.
...
**Zone** (Ch4, foreshadowed in Ch1; enumeration added 2026-05-06) — A domain of practice inside the constellation. Six zones, numbered by proximity to the household: Zone 0 — household; Eave — finance; Zone 2 — knowledge; Zone 3 — emergency preparedness; Zone 4 — land; Zone 5 — public. Primitives are hosted in zones but read by all zones. *(Zone numbers are used in tool names throughout Ch1–Ch5 — Saltbox Zone Zero, Eave, Dam Days Zone 5 — and are consistent with this enumeration.)*

---

## Appendix Sub-Terms

*These terms are named in Ch4 body text and given their full definitions in the Appendix. They are sub-shelves of their parent primitives, not standalone vocabulary entries — but any practitioner working with The Standby or The Gate will encounter them.*

### The Standby — Six-Word Vocabulary (App I)

**A call** (Ch4 body text, full definition App I) — A specific active event within The Standby's activated state. An open call triggers roster deployment and stock release; the system runs in active until the call stands down.

**The debrief** (Ch4 body text, full definition App I) — After-action synthesis conducted once a call stands down. The mechanism by which the Standby learns from each activated event.

**Standby stock** (Ch4 body text, full definition App I) — The always-on reserves maintained during resting state. The physical/material sub-shelf of the Standby primitive; also survives as a sub-shelf noun inside the umbrella alongside The Common Pantry and The Watch.

**The watch** (Ch4 body text, full definition App I) — The active-monitoring posture during resting state: reading the morning advisory, keeping contact trees current, running generator test-starts. Also named as a rejected umbrella name for The Standby (too fast-side-only to hold the slow shelf).

*Note: The Common Pantry is the second rejected umbrella name for The Standby — held as an internal sub-shelf. It could hold the slow side but could not hold an active fire call without straining.*

**Four-rung severity ladder:** advisory / standby / active / standdown

### The Gate — Eight-Word Vocabulary (App II)

**A calm membrane** (App II) — The governing metaphor for The Gate: selectively permeable, alive, not a wall and not an open door. Describes how the Gate holds bright side and massity simultaneously without collapsing into either.

**A category** (App II) — The domain a mapping belongs to, used to organize the Gate's ledger of registered correspondences.

**A mapping** (App II) — A registered correspondence between a bright-side term and its massity equivalent. The foundational record in the Gate's ledger.

**A substitution** (App II) — One applied instance of a mapping: the act of replacing a term from one side with its mapped equivalent for a specific document or context.

**A translation** (App II) — The auditable record of what crossed the Gate and what changed in the crossing.

*Note: Four single-side or single-direction names were rejected as Gate umbrella candidates and survived as sub-shelves or reference points: Translator (collapses posture into pure transaction), Filter (subtractive mis-frame), Censor (carries punitive weight the metaphor refuses), Glossary (dictionary without the room).*

**Four-rung severity ladder:** draft / under-review / cleared / refused
...
**The Siphon** *(Ch4)* — *Decision C: confirmed as Eave internal vocabulary.*
"The Siphon is the bill that leaves before you see the money." This is envelope-budget vocabulary belonging to the Eave app. It is a named concept within Eave's internal vocabulary, not a cross-constellation primitive requiring a formal entry in the shared glossary.
...
The Zone entry in the Formal Vocabulary section above now enumerates all six zones by number: Zone 0 — household; Eave — finance; Zone 2 — knowledge; Zone 3 — emergency preparedness; Zone 4 — land; Zone 5 — public. The numbered zone names used throughout Ch1–Ch5 (Saltbox Zone Zero, Eave, Dam Days Zone 5) are consistent with this enumeration.
