# Agents working in `artifacts/practitioners-guide-v2`
...
`source = 'artifacts/practitioners-guide-v2'`, then flow into `deadhead_items` when the
...
`putOnKitchenTable({ title, source: "artifacts/practitioners-guide-v2" })`. **Do not**
