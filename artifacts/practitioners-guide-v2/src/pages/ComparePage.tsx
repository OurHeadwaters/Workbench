...
interface CompareRow {
  ...
  unit?: string;
  hint?: string;
  /** All three scenarios are byte-identical for this row. */
  identical?: boolean;
}
...
function buildRows(): CompareRow[] {
  ...
  return [
    ...
    },
    {
      ...
      v4: v4.salts.shadowLabour.adjustedNet,
      identical: true,
    },
    {
      bucket: "807 CDP",
      ...
      v4: v4.contracts.cdp807.pAndL.netCash,
      identical: true,
    },
    {
      bucket: "Agency",
    ...
    },
    {
      ...
      v4: v4.contracts.agency.payrollTotal,
      unit: "/mo",
    },
    {
      bucket: "Agency",
      ...
      v4: v4.contracts.agency.costBasisSepOnward,
      unit: "/mo",
    },
    {
      bucket: "Agency",
      ...
      v4: v4.contracts.agency.monthlySurplusSepOnward,
      unit: "/mo",
    },
    {
      bucket: "Agency",
      ...
      v4: v4.contracts.agency.capitalRecoveryMonths,
      unit: " mo",
    },
    {
      bucket: "Agency",
      metric: "Renegotiation triggers (count)",
      v2: v2.contracts.agency.renegotiationTriggers.length,
      v3: v3.contracts.agency.renegotiationTriggers.length,
      v4: v4.contracts.agency.renegotiationTriggers.length,
      unit: "",
    },
    {
      bucket: "Agency",
      ...
      v4: v4.contracts.agency.totals18mo.surplusDeployed,
    },
    {
      bucket: "Agency",
      ...
      v4: v4.contracts.agency.totals18mo.reserve,
    },
    {
      bucket: "Agency",
      ...
      v4: v4.contracts.agency.totals18mo.innovation,
    },
    {
      bucket: "Agency",
      ...
      v4: v4.contracts.agency.totals18mo.giving,
    },
    {
      bucket: "Brightside",
      ...
      v4: v4.brightside.revenueTarget.cumulative18mo,
      identical: true,
    },
    {
      bucket: "Brightside",
      ...
      v4: v4.brightside.surplusDeployment.surplus,
      identical: true,
    },
    {
      bucket: "Brightside",
      ...
      v4: v4.brightside.surplusDeployment.ownerTake,
      identical: true,
    },
    {
      bucket: "Personal",
    ...
    <div className="space-y-6" data-testid="page-compare">
      <header className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          >
            Three realities. Same numbers. Side by side.
          </h1>
          <p className="mt-2 text-muted-foreground max-w-3xl">
            Salts and Brightside are identical across all three — only Community Contracts
            (and therefore personal cash) move. V4 is the right-priced engagement against the same
            lean roster as V3 — the price reflects the leverage, not a discount.
          </p>
        </div>
      </header>
            ...
            <table className="w-full text-sm min-w-[760px]">
              <thead className="text-left text-muted-foreground">
                <tr className="border-b border-card-border">
                  ...
                  <th className="py-2 pr-4 font-medium text-right num">
                    <span style={{ color: v3.accent }}>V3</span> · Lean
                  </th>
                  <th className="py-2 pr-4 font-medium text-right num">
                    <span style={{ color: v4.accent }}>V4</span> · Right-priced
                  </th>
                  <th className="py-2 pr-4 font-medium text-right num">Δ V4 − V3</th>
                </tr>
              </thead>
              <tbody>
                {items.map((r) => {
                  const delta = r.v4 - r.v3;
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-2 pr-4 text-right num">{fmt(r.v2, r.unit)}</td>
                      <td className="py-2 pr-4 text-right num">{fmt(r.v3, r.unit)}</td>
                      <td
                        className="py-2 pr-4 text-right num font-medium"
                        style={{ color: v4.accentInk }}
                      >
                        {fmt(r.v4, r.unit)}
                      </td>
                      <td
                      ...
                      >
                        {sameSign ? "—" : fmtDelta(delta, r.unit)}
                      </td>
                    </tr>
                  );
                })}
      ...
      <SectionCard title="What this is asking you to weigh" accent={v4.accent}>
        <ul className="text-sm text-muted-foreground space-y-2 list-disc pl-5">
          <li>
            <strong className="text-foreground">Service capability vs surplus tightness vs price discipline.</strong>{" "}
            V2 keeps the Transparency Stack Engineer + Junior Analyst — bigger team, slightly
            higher monthly burn. V3 cuts both, lower burn but a thin ~28% margin. V4 holds V3's
            lean roster but lifts the fee so the Sep-onward gross margin lands at ~38.6% — the
            band the founder needs for an 18-month commitment.
          </li>
          <li>
            <strong className="text-foreground">Capital recovery speed.</strong> V2 and V4 retire
            the $112k debt stack in a clean 3 months (Jun–Aug). V3 takes ~4 months at the
            underpriced $90k/mo fee, which also pushes Brightside Launch Month from September into
            October.
          </li>
          <li>
            <strong className="text-foreground">War chest size.</strong> V4 builds the largest
            Reserve / Innovation / Giving war chest of any scenario — the right-priced surplus
            does the work the lean roster lets it do.
          </li>
          <li>
            <strong className="text-foreground">Personal cash unchanged across all three.</strong>{" "}
            Lead draw stays at $18k/mo in the published 18-month numbers. V4's renegotiation
            triggers describe the month-12 step in the Contracts page — pre-baked, not negotiated
            from scratch later.
          </li>
        </ul>
      </SectionCard>
