...
- Renames in any other artifact (codetry-handbook, books, library, northern-band,
...
| 23 | **Hub Coordinator (Dryden)** | `data/v3.ts`, `data/v4.ts` roster | — | *Keep.* This is a load-bearing named role decided in the 2026-04-28 Northern Band roster sync; it is not drift. Listed so the founder sees we walked past it intentionally. | None. | proposed |
