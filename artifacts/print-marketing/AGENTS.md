# Agents working in `artifacts/print-marketing`
...
`source = 'artifacts/print-marketing'`, then flow into `deadhead_items` when the
...
`putOnKitchenTable({ title, source: "artifacts/print-marketing" })`. **Do not**
