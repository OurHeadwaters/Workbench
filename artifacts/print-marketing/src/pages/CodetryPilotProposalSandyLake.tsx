...
const COMMUNITY = "Sandy Lake First Nation";
const COMMUNITY_SHORT = "Sandy Lake";
...
function buildPlainText(): string {
  return [
    ...
    "OVERVIEW",
    "",
    `This document outlines the four-phase structure for a Codetry community store pilot in ${COMMUNITY}. It is designed as a first-contact document — specific details, timelines, and pricing are confirmed once introductions have been made and ${COMMUNITY_SHORT} decides it wants to move forward.`,
    "",
    `The model is trial-first: ${COMMUNITY_SHORT} can stop at any point, and everything built stays with the community. No deliverable lives on a Headwaters server. No tool requires a Headwaters contract to keep running.`,
    "",
    "---",
    "",
    ...
    "",
    `→ Physical infrastructure: receiving setup, storage, shelving — sized to ${COMMUNITY_SHORT}'s space and access realities`,
    ...
    `→ Demand data documented: what gets used, what's missing, what ${COMMUNITY_SHORT} actually needs`,
    "",
    ...
    `→ ${COMMUNITY_SHORT} store generates its first clean financial record`,
    "→ Community feedback integrated into product mix",
    `→ ${COMMUNITY_SHORT} band council receives first financial summary — what the store costs, what it earns, what the next year looks like`,
    "",
    "---",
    "",
    ...
    `→ Community engagement deepens: feedback sessions, local sourcing conversations, ${COMMUNITY_SHORT}'s longer-term food vision starts to take shape`,
    ...
    `→ A clean record for funders and a clear path to Pilot #2 — the second community that can learn from what ${COMMUNITY_SHORT} built`,
    "",
    `Phase 1 built the plan. Phase 2 proved it could run. Phase 3 showed it pays for itself. Phase 4 makes it ${COMMUNITY_SHORT}'s.`,
    "",
    "---",
    "",
    "COMMUNITY OWNERSHIP",
    ...
    "",
    `At the end of Phase 4, ${COMMUNITY_SHORT} should be able to run the store, train the next coordinator, place orders independently, and report to funders and band council without any outside support. That is the measure of success.`,
    "",
    "---",
    "",
    "NEXT STEPS",
...
const phases = [
  ...
  },
  {
    ...
    deliverables: [
      ...
      `A clean record for funders and a clear path to Pilot #2 — the second community that learns from what ${COMMUNITY_SHORT} built`,
    ],
    note: `Phase 1 built the plan. Phase 2 proved it could run. Phase 3 showed it pays for itself. Phase 4 makes it ${COMMUNITY_SHORT}'s.`,
  },
];
