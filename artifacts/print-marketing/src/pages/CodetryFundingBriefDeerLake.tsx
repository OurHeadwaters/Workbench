...
function buildPlainText(): string {
  return [
    ...
    `Community Store Partnership — ${COMMUNITY}`,
    "May 2026",
    "",
    ...
    `→ Community Coordinator — a person hired from or near ${COMMUNITY_SHORT} who handles receiving, reporting, and local knowledge transfer.`,
    "→ Supply Chain Partner — the 807 Food Co-operative and its network of northern Ontario producers.",
    "→ Codetry Trainer — the person who teaches the community coordinator to run the Codetry tools independently.",
    "",
    ...
    "THE 807 CONNECTION",
    "",
    `The 807 Food Co-operative is building a permanent supply line from producers in Northwestern Ontario into First Nations communities that have historically had no access to it. ${COMMUNITY_SHORT} is exactly the community this line was designed to reach.`,
    "",
    "Grant applications for this supply line are being submitted in June 2026. The demand data gathered in Phase 2 is what backs those applications — making Phase 1 in summer 2026 a prerequisite for the January 2027 winter road activation.",
    "",
    "---",
    "",
    "THE ASK",
    "",
    `Headwaters is ready to begin Phase 1 with ${COMMUNITY}. The first engagement is a six-week planning phase at $28,000 flat. No retainer. No follow-on obligation. ${COMMUNITY_SHORT} walks away with a complete plan, a hiring guide, a grant roadmap, and a named next step. Whether they proceed from there is entirely their decision.`,
    "",
    "The work is ready. The supply line is being built. The window is now.",
    "",
    "---",
    "",
...
const constellationRoles = [
  ...
  },
  {
    ...
    name: `Hired from ${COMMUNITY_SHORT}`,
    desc: `A person from or near ${COMMUNITY_SHORT}. Handles day-to-day receiving, distribution, and reporting. This role is the knowledge anchor — everything transfers through them.`,
  },
  {
    role: "Supply Chain Partner",
    name: "807 Food Co-operative",
    desc: "Northern Ontario producers and distribution infrastructure. The 807 network brings real product from the Dryden region into communities that couldn't access it before.",
  },
  {
    role: "Codetry Trainer",
    name: "Knowledge transfer",
    desc: `Trains the community coordinator to run the tools independently. The trainer's job is to make themselves unnecessary. Local knowledge stays in ${COMMUNITY_SHORT}.`,
  },
];

export function CodetryFundingBriefDeerLakePage() {
  return (
    <div className="page-letter" style={PAGE}>
          ...
          <div style={{
            ...
            <div>
              ...
              <h1 style={{ fontFamily: "Fraunces, Georgia, serif", fontSize: "1.65rem", fontWeight: 700, color: CREAM, margin: 0, lineHeight: 1.15, letterSpacing: "-0.01em" }}>
                {COMMUNITY}<br />
                <span style={{ fontWeight: 400, fontStyle: "italic", fontSize: "1.3rem" }}>Community Store Partnership</span>
              </h1>
            </div>
          ...
          <div style={{ flex: 1, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 0 }}>
            ...
            {/* Left column */}
            <div style={{ padding: "0.42in 0.38in 0.32in 0.65in", borderRight: "1px solid rgba(31,61,46,0.12)", display: "flex", flexDirection: "column", gap: "0.28in" }}>
              ...
              <section>
                ...
                <p style={{ fontFamily: "Inter, system-ui, sans-serif", fontSize: "0.76rem", lineHeight: 1.68, color: INK, marginBottom: "0.14in" }}>
                  The 807 Food Co-operative is building a permanent supply line from producers in Northwestern Ontario into First Nations communities. {COMMUNITY_SHORT} is the kind of community this line was built to reach.
                </p>
                <p style={{ fontFamily: "Inter, system-ui, sans-serif", fontSize: "0.76rem", lineHeight: 1.68, color: INK }}>
                  Grant applications for this supply line are being submitted June 2026. The demand data gathered during Phase 2 is what backs those applications — making summer 2026 the critical window.
                </p>
              </section>
              ...
              <section>
                ...
                <p style={{ fontFamily: "Inter, system-ui, sans-serif", fontSize: "0.76rem", lineHeight: 1.68, color: INK }}>
                  Headwaters is ready to begin Phase 1 with {COMMUNITY}. The first engagement is a six-week planning phase at $28,000 flat. No retainer. No follow-on obligation. {COMMUNITY_SHORT} walks away with a complete plan and a named next step. Whether they proceed is entirely their decision.
                </p>
              </section>
              ...
              <div style={{ background: EVERGREEN, borderRadius: 5, padding: "0.22in 0.28in", marginTop: "auto" }}>
                ...
                <p style={{ fontFamily: "Inter, system-ui, sans-serif", fontSize: "0.68rem", color: "rgba(244,237,224,0.72)", margin: 0, lineHeight: 1.5 }}>
                  ...
                  Everything built stays with {COMMUNITY_SHORT}.
                </p>
              </div>
            ...
            <div style={{ padding: "0.42in 0.65in 0.32in 0.38in", display: "flex", flexDirection: "column", gap: "0.22in" }}>
              ...
              {/* Closing line */}
              <div style={{ marginTop: "auto", borderTop: "1px solid rgba(31,61,46,0.1)", paddingTop: "0.18in" }}>
                <p style={{ fontFamily: "Fraunces, Georgia, serif", fontSize: "0.8rem", fontStyle: "italic", color: EVERGREEN, lineHeight: 1.5, margin: 0 }}>
                  "The work is ready. The supply line is being built. The window is now."
                </p>
              </div>
...
export default function CodetryFundingBriefDeerLake() {
  return (
    <>
      <PrintNav
        targetId="pdf-target"
        filename="headwaters-codetry-funding-brief-deer-lake.pdf"
