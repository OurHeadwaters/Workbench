...
function buildPlainText(): string {
  return [
    ...
    "",
    `${COMMUNITY_SHORT} has existing infrastructure — including the hotel — that most communities don't have when they start this work. That's an advantage. It means Phase 1 isn't just planning from scratch; it's looking at what's already running, what it can tell us about demand, and how we build the supply model around real numbers instead of estimates.`,
    "",
    `The picture I'm proposing: use the first year to gather real demand data through existing operations, rotate supply through the channels that are already working, and use that year to write the grants that fund the 807 Food Co-operative supply line into ${COMMUNITY_SHORT} in 2027. By the time that line is built, ${COMMUNITY_SHORT} already has a season of operations behind it and the financial record to back the grant.`,
    "",
    ...
    "",
    `I'd welcome a conversation. The work is ready to go — and ${COMMUNITY_SHORT} is the community I'm hoping to do it with.`,
    "",
    "Respectfully,",
    "",
    "Bobbie Parr",
...
export function CodetryIntroLetterDeerLakePage() {
  return (
        <div className="page-letter" style={PAGE}>
          ...
          <div style={{ flex: 1, padding: "0.52in 0.75in 0.4in", display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.18in", flex: 1 }}>
              ...
              <p style={{ fontFamily: "Inter, system-ui, sans-serif", fontSize: "0.82rem", lineHeight: 1.7, color: INK, margin: 0 }}>
                {COMMUNITY_SHORT} has existing infrastructure — including the hotel — that most communities don't have when they start this work. That's an advantage. It means Phase 1 isn't planning from scratch; it's looking at what's already running, what it can tell us about real demand, and how we build the supply model around actual numbers instead of estimates.
              </p>

              <p style={{ fontFamily: "Inter, system-ui, sans-serif", fontSize: "0.82rem", lineHeight: 1.7, color: INK, margin: 0 }}>
                The picture I'm proposing: use the first year to gather real demand data through existing operations, rotate supply through channels that are already working, and use that year to write the grants that fund the 807 Food Co-operative supply line into {COMMUNITY_SHORT} in 2027. By the time that line is built, {COMMUNITY_SHORT} already has a season of operations behind it and the financial record to back the grant.
              </p>
...
export default function CodetryIntroLetterDeerLake() {
  return (
    <>
      <PrintNav
        targetId="pdf-target"
        filename="headwaters-codetry-intro-letter-deer-lake.pdf"
