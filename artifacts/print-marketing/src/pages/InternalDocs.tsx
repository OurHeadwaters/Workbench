...
const ZONES: Array<{
  ...
  },
  {
    ...
    docs: [
      ...
      { href: "/market-display", title: "Farmers Market Display Card", label: "Parr's Jars · Farmers Market", desc: "Bold, large-type display card readable across a market table." },
      ...
      { href: "/poster-market", title: "Poster — Combined Market Presence", label: "Community · Farmers Market", desc: '"Find us at the market" poster combining Parr\'s Jars and Headwaters.' },
      { href: "/letter-konstantinos", title: "Outreach Letter — Konstantino's Pizza", label: "Dryden Local Business", desc: "Formal cold letter: free demo site offer, $40/mo hosting, $75 referral bonus." },
      { href: "/letter-hinterland", title: "Outreach Letter — Hinterland & Co.", label: "Dryden Local Business", desc: "Warm informal letter: free demo site, coffee-and-walkthrough tone, same referral terms." },
  ...
  },
  {
    ...
    docs: [
      ...
      { href: "/overview", title: "Project Overview — All Nine Headwaters Tools", label: "Start here", desc: "Plain-language visual guide — what every tool does and how they connect. Includes The Stomping Grounds (thestompinggrounds.com)." },
