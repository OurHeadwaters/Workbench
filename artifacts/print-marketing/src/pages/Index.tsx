...
const outreachPieces = [
  ...
  {
    href: "/deer-lake-why-now",
    title: "Why Deer Lake. Why Now.",
    label: "Deer Lake",
    desc: "The specific page that makes the recipient feel seen. What Deer Lake already has (hotel, winter road, band governance), the 807 supply chain flow visualized, and the urgency argument: the January 2027 winter road is the unlock — Phase 1 must begin summer 2026. Letter size (8.5×11).",
    icon: "🏔️",
  },
  {
    href: "/codetry-funding-brief-deer-lake",
    title: "Partnership & Funding Brief — Deer Lake First Nation",
    label: "Deer Lake",
    desc: "Deer Lake-specific two-column brief: what Codetry is, the 807 supply chain connection, the Working Constellation team structure with the coordinator as a Deer Lake hire, and the $28,000 Phase 1 ask. Letter size (8.5×11).",
    icon: "📎",
  },
  {
