...
function buildPlainText(community: string): string {
  return [
    ...
    "May 15, 2026",
    "",
    `To the Leadership of ${community},`,
    "",
    ...
    "",
    `I'd welcome a conversation. The work is ready to go — and ${community} is the community I'm hoping to do it with.`,
    "",
    "Respectfully,",
    "",
    "Bobbie Parr",
...
export function CodetryIntroLetterPage({ community = "your community" }: { community?: string }) {
  return (
