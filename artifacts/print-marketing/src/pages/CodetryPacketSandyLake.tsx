...
import { CodetryIntroLetterSandyLakePage } from "./CodetryIntroLetterSandyLake";
import { CodetryOnePagerPage } from "./CodetryOnePager";
import { CodetryFundingBriefPage } from "./CodetryFundingBrief";
import { CodetryPilotProposalSandyLakePage } from "./CodetryPilotProposalSandyLake";
...
export default function CodetryPacketSandyLake() {
  return (
    <>
      <PrintNav
        targetId="pdf-target"
        filename={`headwaters-codetry-packet-sandy-lake.pdf`}
      />
