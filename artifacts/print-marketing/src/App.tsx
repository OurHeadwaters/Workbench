...
import NANTreaty9Packet from "@/pages/NANTreaty9Packet";
import NANTreaty9ContextBrief from "@/pages/NANTreaty9ContextBrief";
...
import ContinuityOffers from "@/pages/ContinuityOffers";
import CommunityFundingInsert from "@/pages/CommunityFundingInsert";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/nan-treaty9-packet" component={NANTreaty9Packet} />
      <Route path="/nan-treaty9-context-brief" component={NANTreaty9ContextBrief} />
      ...
      <Route path="/continuity-offers" component={ContinuityOffers} />
      <Route path="/community-funding-insert" component={CommunityFundingInsert} />
