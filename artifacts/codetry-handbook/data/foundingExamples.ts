...
export const FOUNDING_EXAMPLE_COMMENTARY: FoundingExampleCommentary[] = [
  ...
  },
  {
    ...
    crossZoneReads: [
      ...
      "Eave — every grant application, CRA filing, and banker meeting is a Gate event. The bright side says *channel*; massity says *bank account*. Same plumbing, different room. The mappings ledger is what keeps the two from drifting apart in the practitioner's own head.",
