...
export const FOUNDING_EXAMPLE_COMMENTARY: FoundingExampleCommentary[] = [
  {
    ...
    crossZoneReads: [
      ...
      "Zone 4 (Arc) — sector-level standby modeling: which industries have which fragilities to which calls (freight → packed weights, power → cold storage, key-person → Karen).",
