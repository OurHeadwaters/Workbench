...
export const FOUNDING_EXAMPLE_COMMENTARY: FoundingExampleCommentary[] = [
  ...
  },
  {
    ...
    whyTwoSided: [
      ...
      {
        kind: "tool",
        label: "RealityCore — Zone 5 doctrine instrument",
        hint: "The formal test for what is real vs. what is story. Open this before making a Gate decision you are uncertain about.",
        route: "https://stomping-path-documentation.replit.app/logic/#reality-core",
      },
      {
        kind: "tool",
        label: "Fallacy Map — Zone 5 doctrine instrument",
        hint: "The named catalogue of reasoning errors practitioners catch in the field — the common moves that make a false crossing look honest, a refusal look cowardly, or a substitution look like an equivalent when it is not.",
        route: "https://stomping-path-documentation.replit.app/logic/#fallacy-map",
      },
    ],
    crossZoneReads: [
