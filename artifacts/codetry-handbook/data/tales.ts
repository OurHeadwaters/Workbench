...
export const TALES: Tale[] = [
  ...
  {
    id: "the-boy-who-swallowed-the-stars",
    title: "The Boy Who Swallowed the Stars",
    subtitle: "A Quantum Adventure for Big Thinkers and Their Families",
    excerpt:
    ...
    body: [
      {
        kind: "para",
        text: "Once upon a time, in a cozy house on Orbit Lane, lived a boy named Zander Starburst.",
      },
      {
        kind: "para",
        text: "At almost twelve, Zander's brain was a blazing supernova of ideas. Rockets made of laughter. Time machines powered by dreams. Questions so big they made the ceiling feel too small.",
      },
      {
        kind: "italic",
        text: "\"What happens to my energy when I die?\" he asked one Tuesday.",
      },
      {
        kind: "italic",
        text: "\"Can thoughts travel faster than light?\" he wondered on Wednesday.",
      },
      {
        kind: "para",
        text: "Zander's ideas burst out with enormous, wonderful energy.",
      },
      {
        kind: "para",
        text: "His mom, Captain Gravity, loved him more than the whole Milky Way. She made sure he was developing well, eating healthy food, and that wild ideas didn't accidentally launch anyone into outer space. She kept the world steady and safe.",
      },
      {
        kind: "para",
        text: "But sometimes Zander's ideas got so big and fast that Captain Gravity's eyes would widen. She would listen for a little while, and then the gravity between them would get heavy for them both — the kind of heavy that ends in everyone feeling squished.",
      },
      { kind: "break" },
      {
        kind: "para",
        text: "Then one afternoon a small, sparkly creature appeared on the windowsill.",
      },
      {
        kind: "para",
        text: "He had the tail of a squirrel, the eyes of someone who had read everything twice, and a tiny chalkboard under his arm that read: PROFESSOR QUARK — Quantum Squirrel, at your service.",
      },
      {
        kind: "italic",
        text: "\"I have been watching your household,\" said Professor Quark, flipping his tail importantly. \"You have a superposition problem. Both of you are right at the same time. Neither of you can tell.\"",
      },
      {
        kind: "italic",
        text: "\"What do we do?\" said Zander.",
      },
      {
        kind: "italic",
        text: "\"Three things,\" said Professor Quark. \"Very small. Very powerful. Shall I?\"",
      },
      {
        kind: "para",
        text: "Captain Gravity pulled up a chair. Zander sat on the floor. Professor Quark cleared his throat.",
      },
      { kind: "break" },
      {
        kind: "para",
        text: "The first thing was the Wonder Bins.",
      },
      {
        kind: "para",
        text: "A special set of stackable bins where every idea goes — the wild ones, the scary ones, the too-big-for-now ones. Mom can add her thoughts too. The bins collapse when they aren't being used and stack neatly on top of each other. Each bin has a transparent envelope label so they can slip in a short project description or title. Nothing gets crushed. Everything stays possible and clearly named.",
      },
      { kind: "break" },
      {
        kind: "para",
        text: "The second thing was Quantum Table Time.",
      },
      {
        kind: "para",
        text: "Fifteen minutes every day where Zander gets to shine like a full star, and Mom gets to share her gravity wisdom — with no interruptions. They simply listen and say: What I heard is…",
      },
      {
        kind: "para",
        text: "At any point in the day when they aren't seeing eye to eye, either one can stop the discussion and say: Put it on the Quantum Table. Zander is responsible for building his case privately and bringing it to their daily Quantum Table Time. If a decision isn't made in that time, it gets gently bumped to the next day's.",
      },
      { kind: "break" },
      {
        kind: "para",
        text: "The third thing was the Strategic Collapse Menu.",
      },
      {
        kind: "para",
        text: "When it's time to decide, they don't collapse into a boring YES or NO. They pick from:",
      },
      { kind: "italic", text: "Tiny Safe Test Version" },
      { kind: "italic", text: "Mix-Master Version (best of both ideas)" },
      { kind: "italic", text: "Keep Wondering Longer" },
      { kind: "italic", text: "Transform-It Twist!" },
      {
        kind: "italic",
        text: "\"Nothing collapses until you choose how,\" said Professor Quark. \"That is the quantum way.\"",
      },
      { kind: "break" },
      {
        kind: "para",
        text: "The next afternoon, Zander put his Indoor Sky City with Trampoline Clouds idea into the Wonder Bins. Mom added her worries about safety and mess. Then they did their first Quantum Table Time.",
      },
      {
        kind: "para",
        text: "For the first time in weeks, no one got squished.",
      },
      {
        kind: "para",
        text: "Together they chose a Tiny Safe Test Version: a pillow fort with glow-stick stars and one small trampoline.",
      },
      {
        kind: "para",
        text: "It was ridiculous. It was glorious. Zander laughed so hard he almost floated.",
      },
      { kind: "break" },
      {
        kind: "para",
        text: "Even the biggest questions — the ones about energy and death and light — went into the Wonder Bins now. Sometimes Mom added a thought. Sometimes they sat with them at Quantum Table Time and just named what they didn't know yet.",
      },
      {
        kind: "para",
        text: "That turned out to be enough. More than enough.",
      },
      {
        kind: "para",
        text: "Their new words spread through the house like starlight:",
      },
      { kind: "italic", text: "\"Superposition time!\" or \"Put it on the Quantum Table!\"" },
      {
        kind: "para",
        text: "And instead of becoming a black hole, Zander and Captain Gravity became a double star system — two bright, strong lights orbiting each other, sharing energy instead of stealing it.",
      },
      { kind: "break" },
      {
        kind: "para",
        text: "Zander still had enormous ideas.",
      },
      {
        kind: "para",
        text: "Mom still kept him safe.",
      },
      {
        kind: "para",
        text: "But now their love had room to grow without collapsing.",
      },
      {
        kind: "para",
        text: "And somewhere in the quantum playground, Professor Quark the Quantum Squirrel gave a satisfied little flip of his sparkly tail.",
      },
      { kind: "break" },
      {
        kind: "italic",
        text: "The End… (or one of many wonderful possible beginnings!)",
      },
    ],
    authorNote:
      "Every big idea needs a safe place to land. The Wonder Bins, the Quantum Table, the Strategic Collapse Menu — these aren't just for children. Any two people trying to share a life without crushing each other's light could use a system for holding ideas gently. The pillow fort was the point all along.",
  },
];
