  ...
  chapters: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          kind: "subhead",
          text: "How the instruments are built.",
        },
        {
          kind: "para",
          text:
        ...
        {
          kind: "subhead",
          text: "Why the Rename Test exists.",
        },
        {
          kind: "para",
          text:
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          kind: "subhead",
          text: "How the discipline began.",
        },
        {
          kind: "para",
          text: "The work began not with a theory but with a condition: people already stretched past their limits, pulled sideways in a dozen directions at once. The immediate temptation — add more pressure, add more complicated systems — was the wrong answer. What the conditions called for was a model that lets ordinary people make capacity-creating moves consciously, at the kitchen table, in a form that does not break when many tables eventually link together.",
        },
        {
          kind: "subhead",
          text: "The search and the result.",
        },
        {
          kind: "pull",
          text: "The search began in overload. The result is a repeatable way to restore and expand capacity that stays human-scaled at the table and still works when many tables join.",
        },
        {
          kind: "callout",
          text: "That is the through-line: from the original need to the geometry, the primitives, the kits, and the 720° return pass.",
        },
        {
          kind: "tool",
          label: "Word Walk",
...
const partII: Part = {
  ...
  chapters: [
    ...
    },
    {
      ...
      partRoman: "DD",
      partLabel: "Deep Dives",
      title: "Different from XP and the system metaphor",
      blocks: [
        {
          kind: "para",
          text:
        ...
        {
          kind: "subhead",
          text: "What happened to the system metaphor practice.",
        },
        {
          kind: "para",
          text:
        ...
        {
          kind: "subhead",
          text: "Codetry is what the system metaphor practice was trying to name.",
        },
        {
          kind: "para",
          text:
    ...
    },
    {
      ...
      partRoman: "DD",
      partLabel: "Deep Dives",
      title: "Different from Brooks and the essence/accident distinction",
      blocks: [
        {
          kind: "para",
          text:
        ...
        {
          kind: "subhead",
          text: "The essence/accident distinction.",
        },
        {
          kind: "para",
          text:
        ...
        {
          kind: "subhead",
          text: "Where codetry walks across the line Brooks drew.",
        },
        {
          kind: "para",
          text:
    ...
    // ── Appendix: Deep Dives ──────────────────────────────────────────────
    // Six passages held from the main chapters — too dense for their source
    // chapter's register but strong enough to keep. Surfaced here for the
    // reader who wants the full technical depth after finishing the book.
    {
      id: "dd-intro",
      number: "DD.A",
      partRoman: "DD",
      partLabel: "Deep Dives",
      title: "Appendix — About this section",
      blocks: [
        {
          kind: "small",
          text: "Deep Dives · appendix · optional reference material · finish the book first.",
        },
        {
          kind: "callout",
          text: "Optional reference material — not in the main reading path. Finish the book first and return.",
        },
        {
          kind: "para",
          text:
    ...
    },
    {
      ...
      partRoman: "DD",
      partLabel: "Deep Dives",
      title: "The Standby — Full Role Definition",
      blocks: [
        {
          kind: "small",
          text: "Deep Dives · I · The Standby · full role definition · held from Chapter 4.",
        },
        {
          kind: "callout",
          text: "Optional reference material — not in the main reading path.",
        },
        {
          kind: "para",
          text:
        ...
        {
          kind: "subhead",
          text: "The Standby as posture substrate.",
        },
        {
          kind: "para",
          text:
        ...
        {
          kind: "small",
          text: "commit:ea059b3~1 · artifacts/practitioner-operating-plan/src/pages/Codetry.tsx (constellation array, The Standby entry)",
        },
      ],
    },
    {
      ...
      partRoman: "DD",
      partLabel: "Deep Dives",
      title: "The Gate — Full Role Definition",
      blocks: [
        {
          kind: "small",
          text: "Deep Dives · II · The Gate · full role definition · held from Chapter 4.",
        },
        {
          kind: "callout",
          text: "Optional reference material — not in the main reading path.",
    ...
    },
    {
      ...
      partRoman: "DD",
      partLabel: "Deep Dives",
      title: "Both-States and Both-Sides — The Structural Comparison",
      blocks: [
        {
          kind: "small",
          text: "Deep Dives · III · both-states vs. both-sides · structural comparison · held from Chapter 4.",
        },
        {
          kind: "callout",
          text: "Optional reference material — not in the main reading path.",
        ...
        {
          kind: "small",
          text: "artifacts/codetry-handbook/data/handbook.ts, lines 428–429",
        },
      ],
    },
    {
      ...
      partRoman: "DD",
      partLabel: "Deep Dives",
      title: "The Refused — A Bar-Level Worked Example",
      blocks: [
        {
          kind: "small",
          text: "Deep Dives · IV · The Refused · bar-level worked example · held from Chapter 4.",
        },
        {
          kind: "callout",
          text: "Optional reference material — not in the main reading path.",
        ...
        {
          kind: "small",
          text: "artifacts/codetry-handbook/data/handbook.ts, lines 421–423",
        },
      ],
    },
    {
      ...
      partRoman: "DD",
      partLabel: "Deep Dives",
      title: "Bright Side — Data Sovereignty at the Facility Level",
      blocks: [
        {
          kind: "small",
          text: "Deep Dives · V · Bright Side · data sovereignty · held from Chapter 2.",
        },
        {
          kind: "callout",
          text: "Optional reference material — not in the main reading path.",
        ...
        {
          kind: "small",
          text: "artifacts/codetry-ship/src/pages/BrightSidePage.tsx, lines 117–119",
        },
      ],
    },
    {
      ...
      partRoman: "DD",
      partLabel: "Deep Dives",
      title: "Northern Store Plan — A Methodology, Not a One-Off",
      blocks: [
        {
          kind: "small",
          text: "Deep Dives · VI · Northern Store Plan · methodology · held from Chapter 2.",
        },
        {
          kind: "callout",
          text: "Optional reference material — not in the main reading path.",
        ...
        {
          kind: "small",
          text: "artifacts/practitioners-guide-v2/src/data/portfolio.ts, lines 192–194",
        },
      ],
    },
  ],
...
const partIV: Part = {
  ...
  chapters: [
    ...
    },
    {
      ...
      partRoman: "III",
      partLabel: "III · The Practice",
      title: "Practice: The first act",
      blocks: [
        {
          kind: "para",
          text: "The first challenge was not to find a client. It was not to write a plan or secure a contract or identify a community in need. The first challenge was to turn the home from a liability into an asset with just one thing: practice.",
        },
        {
          kind: "para",
          text: "Not money. Not expertise borrowed from a course. Not a credential that grants the right to enter. Practice — the slow, daily, repeatable act of doing the work on the ground where you already live.",
        },
        {
          kind: "subhead",
          text: "Zone 0 is the ground, not the starting point",
        },
        {
          kind: "para",
          text: "The home is Zone 0. The practitioner does not begin in a community. The practitioner begins in the household. The garden is planted before the field extension is designed. The books are kept before the community ledger is built. The jar goes on the shelf before the Seasonal Shelf is named. The well pump is installed before the water system is mapped.",
        },
        {
          kind: "para",
          text: "This is not metaphor. It is sequence.",
        },
        {
          kind: "para",
          text: "A practitioner who has not run the rename test on their own household vocabulary cannot run it honestly on a community's. A practitioner who has not held a load-bearing noun under pressure at home cannot hold one under pressure at a council meeting. The standing to speak is earned before the speaking begins, and it is earned in the place where the consequences are personal.",
        },
        {
          kind: "subhead",
          text: "Zone 0 does not atrophy during the field work",
        },
        {
          kind: "para",
          text: "Zone 0 is not a stage the practitioner moves through. It is the ground the practitioner stands on for the whole arc of the work. The community engagement deepens the practice; it does not replace it. The harvest still happens. The jars still go up. The accounts are still kept.",
        },
        {
          kind: "callout",
          text: "The practitioner who lets Zone 0 atrophy in order to serve Zone 3 has abandoned the source of the standing that made the service possible.",
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        },
        {
          kind: "ordered",
          items: [
            "A listening ear — because the practitioner has no standing to observe until they have demonstrated that they can be still.",
            "A keen eye — because observation without attention is just presence.",
            "The grounding data — not extracted, not surveyed, but accumulated through time spent in the room where the work actually happens.",
          ],
        },
        {
          kind: "para",
          text: "What the practitioner is listening for is not problems. Problems are named later, and only after the community has had time to name them first. What the practitioner is listening for is what already works — what names the community has already given to its own practices that carry genuine weight. These names are the foundation everything else is built on.",
        },
        {
          kind: "callout",
          text: "The host is the door. The kitchen table, the fish, the fish story — these are what turn a contract into a journey. The practitioner cannot shortcut the host relationship by being efficient.",
        },
      ],
    },
    {
      ...
      partRoman: "III",
      partLabel: "III · The Practice",
      title: "We don't hide our numbers; we deliver on them",
      blocks: [
        {
          kind: "para",
          text: "The first document the practitioner produces is not a proposal. It is a set of numbers. Not projections. Not assumptions. Not a best-case scenario designed to make the engagement look attractive. Numbers — the margin per unit, the volume required to reach viability, the cost of the equipment the plan depends on, the salary the operator will need to live while the institution gets on its feet. Dollar-honest, before anything else is honest.",
        },
        {
          kind: "para",
          text: "The community that receives a proposal before it receives the numbers will spend the engagement comparing the proposal to hope. The community that receives the numbers first will spend the engagement comparing the proposal to reality. The second community is building something that lasts.",
        },
        {
          kind: "subhead",
          text: "Delivering is different from promising",
        },
        {
          kind: "para",
        ...
        {
          kind: "para",
          text: "The rename test runs on numbers too. *Net operating loss* is the vendor's word for *we spent more than we made this month and here is exactly why*. The community deserves the second sentence.",
        },
        {
          kind: "subhead",
          text: "The hempcrete boundary",
        },
        {
          kind: "para",
          text: "The boundary that holds the community's language is set in hempcrete. Not drywall. Hempcrete — the material that cures over time, that hardens with age, that draws carbon out of the air instead of adding to it. The boundary is not a locked gate. It is a wall whose integrity improves the longer it is maintained.",
        },
        {
          kind: "para",
          text: "And like hempcrete, it requires regular inspection. The practitioner does not set the vocabulary boundary and leave. The same monthly report that delivers the numbers also checks whether the words used to describe them are still carrying the meaning the community put into them, or whether the language has begun to drift toward the vendor's data model, the funder's framework, the government form. Drift is slow. It looks like a reasonable substitution. The inspection catches it before the compound interest of a wrong name runs for another quarter.",
        },
        {
          kind: "callout",
          text: "Goodwill compounds. A community whose vocabulary holds — whose institutions are still called by the names they chose — has built something whose value increases with each generation that inherits it. The language is the asset. The regular inspection is the maintenance schedule.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: "para",
          text: "The transition is not a handover. It is not a delivery of binders and a final invoice. It is the moment when the community solidifies its own voice. And that moment is celebrated.",
        },
        {
          kind: "para",
          text: "There is a difference between a community that has been given a system and a community that has claimed one. The given system requires the donor to maintain goodwill with the recipient; the claimed system requires the community to maintain goodwill with itself. The practitioner's job — from the first kitchen table visit to the final meeting — is to make sure it is the second kind.",
        },
        {
          kind: "subhead",
          text: "A binding experience",
        },
        {
          kind: "para",
        ...
        {
          kind: "para",
          text: "That community is worth defending. Not because it is valuable to an outside observer. Because the people inside it know what they have built and what it cost them. Invaders — economic, linguistic, institutional — would have to get through the gate first. The gate is inspected regularly. It has been inspected regularly since before the invaders arrived.",
        },
        {
          kind: "subhead",
          text: "The feast",
        ...
        {
          kind: "para",
          text: "There will be healing. Not as a side effect of the work. As the thing the work was always pointing toward. There is healing that only a correct name can convey at the right moment — the moment when the community calls its institution by the name it chose, in the voice it trained, in the presence of everyone who helped build it.",
        },
        {
          kind: "callout",
          text: "The whole arc — Zone 0 practice, the host's kitchen table, the dollar-honest numbers, the hempcrete boundary inspected and held — is preparation for that moment. Not for the deliverable. Not for the invoice. For the feast. That moment will be seized.",
        },
      ],
    },
  ],
...
const partQuietExamples: Part = {
  ...
  chapters: [
    ...
    },
    {
      ...
      partRoman: "IV",
      partLabel: "IV · The Quiet Examples",
      title: "Kitchen Table — The Operational Centre",
      blocks: [
        {
          kind: "small",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          kind: "para",
          text: "The Gate Rule is one of the most important disciplines in the Codetry zone model. You can move capital between zones — but you cannot do it invisibly or automatically.",
        },
        {
          kind: "para",
          text: "Each zone is not only a ring of proximity. It is a capital-type boundary. Living, material, experiential, and cultural capital originate in Zone 0 and Zone 1. Social capital is structural to Zone 1 — Kitchen Table — because that is where the relationships that generate it are held. Intellectual capital spans Zones 2 and 3. Financial capital is native to Zone 3 and above. A zone crossing is therefore always a capital-type conversion. When social capital crosses outward and becomes financial capital, something irreplaceable has been moved. The conversion cannot be undone without re-crossing.",
        },
        {
          kind: "subhead",
          text: "The gate decision.",
        },
        {
          kind: "para",
          text: "Converting one form of capital into another is not forbidden. But it requires a gate decision: a moment of conscious consent, recorded and witnessed. Not a market transaction. Not a convenient shortcut. A ceremony — a deliberate crossing that both sides of the gate can name and verify afterward.",
        },
        {
          kind: "para",
          text: "This is the deeper meaning behind the Eave Rule. The rule does not say *never move capital between zones*. It says *no crossing without a gate*. The gate is what makes the crossing legible — to the practitioner, to the community, and to any future audit that needs to understand what moved and why.",
        },
        {
          kind: "subhead",
          text: "The Ramsey Corollary.",
        },
        {
          kind: "pull",
          text: "\"Never borrow from friends and family\" is what people say when they have no gate.",
        },
        {
          kind: "para",
          text: "Dave Ramsey's rule is not wrong. It is the correct prescription for the diagnosis *no gate mechanism*. When there is no ceremony, no record, no defined terms — when the crossing happens because it was convenient and both parties assumed goodwill — the social capital at Zone 1 has been quietly converted into financial obligation at Zone 3, with no gate keeping the record of what crossed and on what terms. The prohibition exists to protect the relationship because the relationship has no other protection.",
        },
        {
          kind: "para",
          text: "Codetry's answer is not the same prohibition. It is: build the gate. Once the gate exists, the crossing can happen with integrity. The practitioner and the community member can both name what moved, on what terms, recorded and witnessed. The social capital at Zone 1 does not disappear into a financial transaction at Zone 3 — it crosses through a gate that both parties can inspect. The Eave Overhang is the constitutional expression of this principle: no Z3 identity or financial capital may compose directly into a Zone 0 or Zone 1 record without a documented gate decision.",
        },
        {
          kind: "callout",
          text: "Build the gate so you *can* cross intentionally when it truly serves the whole system. The gate is not a wall. It is the ceremony that makes the crossing honest.",
        },
      ],
    },
    {
  ...
  chapters: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          kind: "subhead",
          text: "The three-layer stack — a concrete beginning.",
        },
        {
          kind: "para",
          text:
