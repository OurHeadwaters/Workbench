 ...
 * knows which document is open. The right-side chip is a quiet jump-to-
 * recap link, because the recap is the screen the contractor screenshots
 * and sends after the meeting.
 */
