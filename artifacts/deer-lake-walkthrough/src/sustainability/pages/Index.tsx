...
/**
 * The opening page. Names the failure pattern in plain language and
 * uses the hotel as the in-community example. Tees up the rest of the
 * playbook as the alternative ending.
 */
    ...
    <PageFrame
      ...
      standfirst={
        <>
          ...
          reserve has a version of this story. It ends the same way every time.
        </>
      }
    >
      <Card
      ...
      <Reveal label="Why this is the playbook, not another deck">
        <p>
          The pitch decks already exist. The cockpit at{" "}
          <button
            type="button"
          ...
          shows the operator surface in five seconds. The walkthrough at{" "}
          <button
            type="button"
          ...
          sells the engagement to the chief.
        </p>
        <p>
      ...
      <Reveal label="What's in scope · what isn't">
        ...
        <p>
          ...
          about specific named individuals, replication to a second reserve,
