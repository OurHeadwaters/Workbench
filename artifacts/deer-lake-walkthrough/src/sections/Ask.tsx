        ...
        <div className="mt-8 space-y-3">
          ...
          <Reveal label="What this costs, by stage">
            <p>
              ...
              Eight weeks · $175/hr billed rate · practitioner solo. No team hired. The flat fee is intentionally below full-cost — a bounded entry price so the band can walk away before committing.
            </p>
            <p>
              <span className="font-semibold">Stage 2 — distribution live: $39,200/month.</span>{" "}
              Bobbie $175/hr + Tyler $70/hr, 160 hr/mo each. Tyler subcontracted for distribution — client sees two line items. No employer payroll obligations on either party — both invoice through their own businesses. Gas card and insurance billed at cost on top. You bring the operator couple on your own payroll.
            </p>
            <p>
