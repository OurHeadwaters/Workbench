...
/**
 * The cold-chain route. Three top-level lane bullets hold the gist; the
 * shelf composition and the honest-pricing-on-the-tag detail live behind
 * a tap.
 *
...
export default function ColdChain() {
  const lanes = [
    ...
    {
      tag: "Lane 3 · Plane when the road is closed",
      head: "Flown in (April to November)",
      body:
        "Wasaya, Bearskin, and North Star Air. Extra stock on the shelf covers the gap weeks.",
    },
  ];
      ...
      <div className="mx-auto max-w-[36rem] px-6 pt-12 pb-16 flex flex-col">
        ...
        <div className="mt-8 space-y-3">
          <Reveal label="Why two trucks instead of one">
            <p>
              The two trucks are kept separate on purpose. If one truck
              breaks down, the other still runs. A single truck is a single
              point of failure for the whole shelf.
            </p>
          </Reveal>
