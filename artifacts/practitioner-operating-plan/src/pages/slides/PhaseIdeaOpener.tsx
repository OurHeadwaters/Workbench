export default function PhaseIdeaOpener() {
  return (
    <div
    ...
    >
      <div
        className="absolute -left-[10vw] -top-[10vw] w-[55vw] h-[55vw] rounded-full"
        style={{ background: "rgba(244,237,224,0.05)" }}
      />
      <div
        className="absolute right-[6vw] bottom-[8vh] w-[12vw] h-[12vw] rounded-full"
      ...
      <div className="relative z-10 w-full h-full px-[7vw] py-[7vh] flex flex-col justify-between">
        ...
        <div className="max-w-[80vw]">
          ...
          <div className="mt-[3vh] font-body text-[1.7vw] leading-[1.4] opacity-85 max-w-[62vw]">
            Why this contract is the inflection point, and the brand that
            carries the work past it.
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-[3vw] items-end">
          <div>
            ...
            <div className="font-body text-[1.3vw] leading-[1.4] opacity-90">
              Why this matters · Agency vision · Naming Headwaters · Brand &amp;
              IP landscape · Founder action items
            </div>
          </div>
