export default function PhaseContractOpener() {
  return (
    <div
    ...
    >
      <div
        className="absolute -right-[12vw] -bottom-[10vw] w-[55vw] h-[55vw] rounded-full"
        style={{ background: "rgba(244,237,224,0.05)" }}
      />
      <div
        className="absolute left-[8vw] top-[8vh] w-[12vw] h-[12vw] rounded-full"
      ...
      <div className="relative z-10 w-full h-full px-[7vw] py-[7vh] flex flex-col justify-between">
        ...
        <div className="max-w-[80vw]">
          ...
          <div className="mt-[3vh] font-body text-[1.7vw] leading-[1.4] opacity-85 max-w-[62vw]">
            Work the two-week feedback window, agree the value-delivered
            accountability, and get the deal named at the kitchen table.
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-[3vw] items-end">
          <div>
            ...
            <div className="font-body text-[1.3vw] leading-[1.4] opacity-90">
              Value delivered · Naming the deal · The next two weeks ·
