export default function PhaseFulfillmentOpener() {
  return (
    <div
    ...
    >
      <div
        className="absolute -left-[12vw] -bottom-[12vw] w-[55vw] h-[55vw] rounded-full"
        style={{ background: "rgba(184,90,62,0.16)" }}
      />
      <div
        className="absolute right-[7vw] top-[7vh] w-[14vw] h-[14vw] rounded-full"
      ...
      <div className="relative z-10 w-full h-full px-[7vw] py-[7vh] flex flex-col justify-between">
        ...
        <div className="max-w-[80vw]">
          ...
          <div className="mt-[3vh] font-body text-[1.7vw] leading-[1.4] opacity-85 max-w-[62vw]">
            The day the contract is signed, this is the part of the book you
            live in — the team, the rhythm, the cash, the winter plan.
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-[3vw] items-end">
          <div>
            ...
            <div className="font-body text-[1.3vw] leading-[1.4] opacity-90">
              Part I (the life) · Part II (the team) · Part III (hiring) ·
              Budget · Cash flow · Reinvestment · Winter contingency
            </div>
          </div>
