        ...
        <div className="grid grid-cols-3 gap-[1.5vw] mb-[3vh]">
          ...
          >
            <div className="flex items-center gap-[0.6vw] mb-[1.2vh]">
              ...
              <div className="font-mono uppercase tracking-[0.18em] text-[1vw] text-muted">
                Existing
              </div>
            </div>
            ...
            <div className="font-body text-[1.05vw] text-muted leading-[1.4]">
              807's bi-weekly producer lane. Refurbished cold trailer + paid driver, formalising May
              2026 (AGM capital project).
            </div>
          </div>
          ...
          >
            ...
            <div className="font-body text-[1.05vw] text-muted leading-[1.4]">
              Ice-road-rated second vehicle. LFIF (when reopens) via LFFC partnership — deliberately
              a separate envelope from Lane 1.
            </div>
          </div>
          ...
          >
            ...
            <div className="font-body text-[1.05vw] text-muted leading-[1.4]">
              Wasaya, Bearskin, North Star Air for perishables when the winter road is closed. Buffer
              inventory carries the gap.
            </div>
          </div>
        </div>
        ...
        >
          <div className="col-span-4">
            ...
            <div className="font-body text-[1.05vw] opacity-85 leading-[1.5]">
              Nutrition North-eligible items priced after subsidy pass-through. Ineligible items show
              transparent freight cost on the shelf tag — no hidden markups.
            </div>
          </div>
          <div className="col-span-8 grid grid-cols-2 gap-x-[2vw] gap-y-[1.6vh]">
            <div>
              <div
                className="font-mono uppercase tracking-[0.18em] text-[1.05vw] mb-[0.6vh]"
                style={{ color: "#e9c8a8" }}
              >
                Local · Deer Lake
              </div>
