      ...
      <div className="absolute inset-0 px-[5vw] py-[6vh] flex flex-col">
        ...
        <div className="flex-1 grid grid-cols-3 gap-[1.6vw] min-h-0">
          <div className="rounded-[0.4vw] p-[1.8vw] flex flex-col" style={{ background: "var(--slide-paper)" }}>
            <div className="font-mono text-[1.05vw] text-accent font-semibold mb-[1vh]">FINANCIAL SKETCH</div>
            <div className="font-mono uppercase tracking-[0.18em] text-[1vw] text-muted mb-[1.4vh]">Planning-grade · refine in feasibility stage</div>

            <div className="space-y-[1.4vh] font-body text-[1.05vw] leading-[1.4]">
              <div>
                <div className="font-mono uppercase tracking-[0.16em] text-[1vw] text-muted">Community grocery spend</div>
              ...
              <div>
                <div className="font-mono uppercase tracking-[0.16em] text-[1vw] text-muted">Year-1 target market share</div>
                <div className="font-display text-[1.6vw] text-primary font-semibold leading-tight">30–40%</div>
              </div>
              <div>
                <div className="font-mono uppercase tracking-[0.16em] text-[1vw] text-muted">Blended gross margin</div>
              ...
              <div>
                <div className="font-mono uppercase tracking-[0.16em] text-[1vw] text-muted">Opening capex band</div>
                <div className="font-display text-[1.6vw] text-primary font-semibold leading-tight">$400–700k</div>
                <div className="text-muted text-[1.1vw]">Fit-out, freezers, racking, opening inventory, POS, signage</div>
              </div>
              <div>
                <div className="font-mono uppercase tracking-[0.16em] text-[1vw] text-muted">Funding mix</div>
                <div className="text-text text-[1vw] leading-[1.4]">FedNor NODP (capex up to 33%) · Community Futures · ISC CCP · LFFC partnership · band capital</div>
              </div>
            </div>
          </div>

          <div className="rounded-[0.4vw] p-[1.8vw] flex flex-col" style={{ background: "var(--slide-paper)" }}>
            <div className="font-mono text-[1.05vw] text-accent font-semibold mb-[1vh]">6–9 MONTH GANTT</div>
            <div className="font-mono uppercase tracking-[0.18em] text-[1vw] text-muted mb-[2vh]">Site to handoff</div>
          ...
          <div className="rounded-[0.4vw] p-[1.8vw] flex flex-col" style={{ background: "var(--slide-primary)", color: "var(--slide-bg)" }}>
            <div className="font-mono text-[1.05vw] font-semibold mb-[1vh]" style={{ color: "#e9c8a8" }}>WHO BUILDS IT</div>
            <div className="font-mono uppercase tracking-[0.18em] text-[1vw] opacity-75 mb-[1.6vh]">Two options. Pick after you read the room.</div>

            <div className="rounded-[0.3vw] p-[1.4vw] mb-[1.4vh]" style={{ background: "rgba(244,237,224,0.10)" }}>
              <div className="font-mono uppercase tracking-[0.16em] text-[1vw]" style={{ color: "#e9c8a8" }}>Recommended</div>
              ...
              <div className="font-body text-[1vw] leading-[1.45] opacity-95">
                Fixed-term build/launch GM. Day-rate + band-housing + per-diem + success fee on opening + 90-day metrics. Fits inside the store's launch capex; clean exit to advisory.
              </div>
            </div>

            <div className="rounded-[0.3vw] p-[1.4vw]" style={{ background: "rgba(244,237,224,0.04)" }}>
              <div className="font-mono uppercase tracking-[0.16em] text-[1vw] opacity-75">Alternative</div>
              ...
              <div className="font-body text-[1.1vw] leading-[1.45] opacity-85">
                Higher revenue, harder exit. Right if the band wants the launch lead to stay through the second winter.
              </div>
            </div>
