...
> Robin: "Catchment. Channeling the flow."
> Maria: 🥰 🥰

# The inversion

The cliché is "can't see the forest for the trees" — missing the whole because you're too close to the parts. Robin's line inverts it. Her mother is not the picture she missed by being too close. **Her mother is the picture.** The canopy, the soil, the water cycle, the voice carrying through the trunks. Robin has spent her life seeing pieces of that ecosystem through the trees in the foreground. The framework she's now building under the name *Watershed* — catchment, channeling the flow, Zone 0, the household as the headwaters — is structurally what her mother has been the whole time. The work Robin is exporting to Deer Lake, to the practitioner agency, to Pilot #2, to every reserve in the five-year scale plan is her mother's framework getting a name and a Memo string for the first time.

# Why the screenshot matters

Maria asked *what are they doing*, and Robin gave her the language: *catchment, channeling the flow*. Maria replied with two heart-eye emojis. That is the first small signal that the recognition might run both directions — that Maria might see herself in the vocabulary her daughter is building. Not the kids in the photo. Herself in the photo. The water she has been all along, recognised for the first time in her own daughter's words.
...
2. **Channeling water** — Robin's six-year-old defending stepping in poop with *"at least I've been channeling water."* The system as it is lived in the household. The vocabulary transmission downstream from Robin to her kids.
3. **Maria — the headwaters** *(this entry)* — The recognition that the upstream of all of it, the framework Watershed is structurally a translation of, is Robin's mother. The vocabulary transmission upstream that Robin is only now naming.

Headwaters → river → tributary → next watershed. Maria, Robin, the kids. The same ecology in three Zones.

# The phrase Robin gave back
